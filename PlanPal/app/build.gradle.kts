...
android {
    namespace = "com.example.planner_pal"
    compileSdk = 36
    ...
    packaging {
        resources {
            // Tell Gradle to pick the first instance of these files it finds
            pickFirsts += "META-INF/native-image/reflect-config.json"
            // You might encounter more duplicates; add them here as needed.
            // Common ones from iText and other libraries include:
